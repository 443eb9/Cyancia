use iced_core::{
    Element, Layout, Length, Rectangle, Size, Widget, layout, mouse, renderer, widget::Tree,
};
...
impl<Message, Theme, Renderer> Widget<Message, Theme, Renderer> for LayerStackWidget
where
...
impl<'a, Message, Theme, Renderer> From<LayerStackWidget> for Element<'a, Message, Theme, Renderer>
where
    Message: 'a,
    Renderer: iced_core::Renderer + 'a,
{
    fn from(widget: LayerStackWidget) -> Self {
        Element::new(widget)
    }
}
